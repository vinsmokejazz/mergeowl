...
export function CtaSection() {
  ...
  return (
    <div ref={sectionRef} className="px-[40px] py-[120px] text-center border-t border-[var(--border)] relative overflow-hidden">
      <canvas
        ref={canvasRef}
      ...
      <div className="relative z-[3]">
        ...
        <div className="flex gap-[14px] justify-center mb-[56px]">
          ...
          <button className="inline-flex items-center gap-[8px] bg-transparent text-[var(--t2)] text-[15px] font-normal px-[24px] py-[15px] rounded-[var(--r)] border border-[var(--border2)] cursor-pointer font-[family-name:var(--font-b)] transition-all duration-200 hover:border-[var(--em2)] hover:text-[var(--t1)]">
        ...
        <div className="flex gap-[12px] justify-center flex-wrap">
          {[
            ...
            <div key={i} className="flex items-center gap-[8px] bg-[rgba(255,255,255,0.02)] border border-[var(--border)] rounded-[var(--rs)] px-[16px] py-[10px]">
              <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-[var(--em)]">
                {item.icon === 'shield-check' && <><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><path d="M9 12l2 2 4-4"/></>}
        ...
        <div className="flex gap-[48px] justify-center mt-[52px] pt-[44px] border-t border-[var(--border)]">
          {[
            { value: '847', suffix: 'K+', label: 'PRs reviewed' },
            { value: '3.2', suffix: 'K+', label: 'teams onboarded' },
            { value: '38', suffix: 'ms', label: 'avg. latency' },
            { value: '99.9', suffix: '%', label: 'uptime SLA' }
          ].map((stat, i) => (
            <div key={i} className="text-center">
              <div className="font-[family-name:var(--font-d)] text-[30px] text-[var(--t1)]">
                <em className="text-[var(--em)] italic not-italic">{stat.value}</em>{stat.suffix}
              </div>
